...
from keras.layers import Input, concatenate, Conv2D, Conv2DTranspose, MaxPooling2D, Activation, UpSampling2D, BatchNormalization
...
# input_shape=(1024, 1024, 4), concat rcnn result
def get_unet_1024(input_shape=(1024, 1024, 3),
    ...
    # up4 = UpSampling2D((2, 2))(center)
    up4 = Conv2DTranspose(512, (2, 2), strides=(2, 2), padding='valid')(center)
    up4 = Activation('relu')(up4)
    up4 = concatenate([down4, up4], axis=3)
    # up4 = Conv2D(512, (3, 3), padding='same')(up4)
    # up4 = BatchNormalization()(up4)
    ...
    up3 = Conv2DTranspose(256, (2, 2), strides=(2, 2), padding='valid')(up4)
    up3 = Activation('relu')(up3)
    up3 = concatenate([down3, up3], axis=3)
    # up3 = Conv2D(256, (3, 3), padding='same')(up3)
    # up3 = BatchNormalization()(up3)
    ...
    up2 = Conv2DTranspose(128, (2, 2), strides=(2, 2), padding='valid')(up3)
    up4 = Activation('relu')(up2)
    up2 = concatenate([down2, up2], axis=3)
    # up2 = Conv2D(128, (3, 3), padding='same')(up2)
    # up2 = BatchNormalization()(up2)
    # up2 = Activation('relu')(up2)
    ...
    up1 = Conv2DTranspose(64, (2, 2), strides=(2, 2), padding='valid')(up2)
    up1 = Activation('relu')(up1)
    up1 = concatenate([down1, up1], axis=3)
    # up1 = Conv2D(64, (3, 3), padding='same')(up1)
    # up1 = BatchNormalization()(up1)
    ...
    up0 = Conv2DTranspose(32, (2, 2), strides=(2, 2), padding='valid')(up1)
    up0 = concatenate([down0, up0], axis=3)
    # up0 = Conv2D(32, (3, 3), padding='same')(up0)
    # up0 = BatchNormalization()(up0)
    # up0 = Activation('relu')(up0)
    ...
    up0a = Conv2DTranspose(16, (2, 2), strides=(2, 2), padding='valid')(up0)
    up0a = concatenate([down0a, up0a], axis=3)
    up0a = Conv2D(16, (3, 3), padding='same')(up0a)
    up0a = BatchNormalization()(up0a)
    up0a = Activation('relu')(up0a)
    ...
    up0b = Conv2DTranspose(8, (2, 2), strides=(2, 2), padding='valid')(up0a)
